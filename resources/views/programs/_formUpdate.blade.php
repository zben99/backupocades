<div class="row">
    <div class="col-md-12">
        <div class="form-group">
            <label for="nomEdit" class="">Nom <span class="text-danger">*</span></label>
            <div class="">
...
<div class="row">
    <div class="col-md-12">
        <div class="form-group">
            ...
            <div class="">
                <textarea name="description" maxlength="300" class="form-control"  placeholder="description ici" id="descEdit" cols="30" rows="4"></textarea>
